 ...
 * const domain = 'australianroundhouse';
 * const key = process.env.GATSBY_AGILECRM_CODE;
 * const email = 'cherrie@australianroundhouses.com.au'
 */
require("dotenv").config({
    path: `.env.${process.env.NODE_ENV}`,
  });
var AgileCRMManager = require("./agilecrm.js");
var obj = new AgileCRMManager(process.env.GATSBY_AGILECRM_DOMAIN, process.env.GATSBY_AGILECRM_API_KEY, process.env.GATSBY_AGILECRM_EMAIL);
